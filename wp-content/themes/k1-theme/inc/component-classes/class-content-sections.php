...
class ContentSectionComponents {
    ...
    public function hero_section(int $post_id = null, $echo = true, array ...$args) {
        ...
        $markupStart = $has_background_image ? "<section id='hero' class='w-100 py-5 style='background-image:url('{$background_image}')>" : "<section id='hero' class='w-100 py-5' style='background-color:var(--bs-secondary);'>";
        $markupStart .= "
        <div class='container'>
            <div class='row my-5'>
