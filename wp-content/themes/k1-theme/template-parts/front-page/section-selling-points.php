	...
	<div class="container">
		<div class="row">
			<div class="selling-points__figures col-4">
				<img src="<?php k1_get_image_asset_url( 'brokenleaves', 'png' ); ?>" loading="lazy" />
			</div>
			<div class="col">
		...
		<div class="row">
			<p>Don't let ministry pain points stop you from fulfilling your calling. At Kingdom One, we help ministries reduce turnover, find quality candidates and assist with hiring &
				transitions. Transform your ministry work environment to be more courageous, healthy & effective with our HR, finance, and strategic experts. </p>
		</div>
	</div>
</section>